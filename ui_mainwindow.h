...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_Read->setText(QApplication::translate("MainWindow", "Read", Q_NULLPTR));
    } // retranslateUi
